...
[CreateAssetMenu(fileName = "Weapon Data", menuName = "Vampire/Weapon Data")]
public class WeaponData : ItemData
{
    ...
    public Weapon.Stats GetLevelData(int level)
    {
        ...
        Debug.LogWarning(string.Format("Weapon dosen't have its level up stats configured for level {0}", level));
